...
const LightButton = styled(FlexContainer)`
  background: ${(props) =>
    props.mode === 'light' ? '#EB7500' : 'rgba(256,256,256,0.1)'};
...
const DarkButton = styled(FlexContainer)`
  background: ${(props) =>
    props.mode === 'light' ? 'rgba(216,216,216,0.45)' : 'rgba(0,0,0,0.4)'};
  color: ${(props) =>
    props.mode === 'light' ? 'rgba(0,0,0,0.85)' : '#EB7500'};

  svg {
    fill: ${(props) =>
      props.mode === 'light' ? 'rgba(0,0,0,0.8)' : '#EB7500'};
  }
  ...
  return (
    <FlexContainer fs='13px' fw='600'>
      <LightButton
        ...
        mode={props.mode}
      >
        <FlexContainer ml='30px' mr='5px'>
          <IconLight mode={props.mode} />
        </FlexContainer>
        Light
      </LightButton>
      <DarkButton
